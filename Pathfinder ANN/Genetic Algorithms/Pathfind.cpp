...
{	
	...
	int xA, yA, xB, yB;
	xA = entity->m_Pos.x / entity->game->boxSize;
	yA = entity->m_Pos.y / entity->game->boxSize;
	xB = entity->opponent->m_Pos.x / entity->game->boxSize;
	yB = entity->opponent->m_Pos.y / entity->game->boxSize;
	...
	//std::vector<string> routes(8);
	//routes[0] = (astar(xA, yA, xB + 1, yB));
	//routes[1] = (astar(xA, yA, xB - 1, yB));
	//routes[2] = (astar(xA, yA, xB, yB + 1));
	//routes[3] = (astar(xA, yA, xB, yB - 1));
	//routes[4] = (astar(xA, yA, xB - 1, yB - 1));
	//routes[5] = (astar(xA, yA, xB - 1, yB + 1));
	//routes[6] = (astar(xA, yA, xB + 1, yB + 1));
	//routes[7] = (astar(xA, yA, xB + 1, yB - 1));	
	...
	//		route = routes[i];
	//	}
	//	else if (routes[i].size() < route.size() && routes[i] != "")
	//	{
	//		route = routes[i];
	//	}
	//}
